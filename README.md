...
These write capabilities currently target Dander's unreleased capability contract. This draft must
not be published until a compatible Dander release exists and the package dependency floor names
that release.
